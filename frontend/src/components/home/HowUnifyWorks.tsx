...
export default function HowUnifyWorks() {
  ...
  return (
    <section
      className="w-full bg-slate-50 relative pt-12 pb-16 md:pb-20 max-w-400 mx-auto"
      dir={isRTL ? "rtl" : "ltr"}
    >
        ...
        >
          ...
          <div className="relative">
            <div className="hidden md:flex items-center justify-between mb-8 relative z-10">
              ...
              <button
                onClick={() =>
                  setFeatureSlideIndex((prev) => (prev === 0 ? 1 : 0))
                }
            ...
            <div className="hidden md:block overflow-hidden py-4 -my-4">
              <motion.div
                className="flex"
                animate={{
                  x: featureSlideIndex === 0 ? "0%" : isRTL ? "50%" : "-50%",
                }}
            ...
            >
              ...
              >
                {(isRTL ? [...homeFeatures].reverse() : homeFeatures).map(
                  (item, index) => (
                    <HomeFeatureCard
                      key={index}
                      icon={item.icon}
                      ...
                      totalCards={6}
                      onDotClick={(idx) =>
                        setHomeCardIndex(isRTL ? 5 - idx : idx)
                      }
                    />
                  ),
                )}
