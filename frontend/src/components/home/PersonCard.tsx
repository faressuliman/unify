    ...
    <>
      ...
      >
        <div className="relative h-48 sm:h-52 overflow-hidden bg-[#faf9f5]">
          <div
            className={`absolute top-0 ${isRTL ? "left-0" : "right-0"} z-10`}
          >
            <div
              className={`bg-primary text-[#1c190d] text-[10px] sm:text-xs font-black px-3 sm:px-4 py-1.5 sm:py-2 uppercase tracking-widest shadow-sm ${isRTL ? "rounded-br-lg" : "rounded-bl-lg"}`}
            >
              {profile.status}
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-1.5 sm:space-y-2 mb-4">
              <div className="flex items-center gap-2 text-slate-500 text-xs sm:text-sm">
                ...
                <span className="truncate" dir={directionFor(profile.location)}>
                  {profile.location}
                </span>
              </div>
              <div className="flex items-center gap-2 text-slate-500 text-xs sm:text-sm">
              ...
              <div className="flex items-center gap-2 text-slate-500 text-xs sm:text-sm">
                ...
                <span className="truncate" dir={directionFor(profile.details)}>
                  {profile.details}
                </span>
              </div>
            </div>
