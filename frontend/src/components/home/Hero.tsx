      ...
      <div className="absolute inset-0 -z-10 w-full h-full overflow-hidden pointer-events-none">
        {backgroundImages.length > 0 ? (
          ...
          <>
            ...
            <div className="absolute top-1/2 left-1/4 md:left-1/3 -translate-y-1/2 w-[60vw] h-[60vw] md:w-[50vw] md:h-[50vw] max-w-150 max-h-150 bg-blue-100/50 rounded-full blur-2xl opacity-60"></div>
            <div className="absolute top-1/2 right-1/4 md:right-1/3 -translate-y-1/2 w-[60vw] h-[60vw] md:w-[50vw] md:h-[50vw] max-w-150 max-h-150 bg-teal-50/60 rounded-full blur-2xl opacity-60"></div>
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[70vw] h-[70vw] md:w-[60vw] md:h-[60vw] max-w-200 max-h-200 bg-primary/10 rounded-full blur-[60px] opacity-50"></div>
