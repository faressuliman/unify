        ...
        >
          <div className="modal-panel flex h-full min-h-0 flex-col">
            ...
            <div className="relative z-10 px-5 pt-7 pb-5 sm:px-8 border-b border-slate-100 bg-slate-50/50">
              <div
                className={`absolute top-5 ${isRTL ? "left-5" : "right-5"} z-20`}
              >
            ...
            <div className="flex-1 min-h-0 overflow-y-auto">
              <form onSubmit={handleSubmit} className="space-y-6 p-5 sm:p-8">
                  ...
                  <div>
                    <SelectMenu
                      ...
                      options={[
                        {
                          value: "not_sure",
                          label: t.confidenceOptions.notSure,
                        },
                        {
                          value: "possibly",
                          label: t.confidenceOptions.possibly,
                        },
                        {
                          value: "pretty_sure",
                          label: t.confidenceOptions.prettySure,
                        },
                        {
                          value: "very_sure",
                          label: t.confidenceOptions.verySure,
                        },
                      ]}
                      onChange={(value) =>
                ...
                <div className="flex items-center gap-4 rounded-2xl border border-blue-200/60 bg-blue-50/50 px-5 py-4">
                  ...
                  <span className="text-[14px] font-medium text-blue-800/90 leading-relaxed">
                    {t.sightingNotice}
                  </span>
                </div>
