export const ar = {
    translations: {
        ...
        'donate.oneTime': 'لمرة واحدة',
        'donate.monthly': 'شهرياً',
        'donate.customAmount': 'مبلغ مخصص',
        'donate.yourDetails': 'بياناتك',
        'donate.placeholderName': 'الاسم الكامل',
        'donate.placeholderEmail': 'البريد الإلكتروني',
        'donate.donateCTA': 'تبرع',
        'donate.securePayments': 'المدفوعات آمنة ومشفرة',
        'donate.storyTitle': 'الأمل هو فعل.',
        'donate.storyDesc1': '"لا يوجد ألم يضاهي الصمت القاتل لعدم معرفة مكان طفلك. لقد بنينا هذه المنصة لأننا نؤمن بأن التكنولوجيا يجب أن تخدم أشد ساعات البشرية يأسًا."',
        'donate.storyDesc2': 'مهمتنا لا تقتصر على الكود البرمجي أو الخرائط - بل تدور حول تقصير الوقت بين الاختفاء المأساوي ولم الشمل المبهج. نحن مدعومون كليًا بأشخاص مثلك يرفضون ترك الأمل يتلاشى.',
        'donate.teamName': 'فريق مشروع يونيفاي',
        'donate.impactTitle': 'أثر تبرعك',
        'donate.impactDesc': 'عندما يُفقد طفل، فإن الـ 24 ساعة الأولى تكون حاسمة. يتيح دعمك المالي لمنصتنا العمل بشكل فوري - نشر التنبيهات، تحليل البيانات، وتنسيق المتطوعين.',
        'donate.impact1Title': '10$ تنشر الوعي',
        'donate.impact1Desc': 'يسمح لنا بتعزيز ملصقات المفقودين والتنبيهات عبر شبكات التواصل الاجتماعي المستهدفة في المناطق المحلية بشكل فوري.',
        'donate.impact2Title': '50$ تدعم التكنولوجيا',
        'donate.impact2Desc': 'تحافظ على خوارزميات المطابقة بالذكاء الاصطناعي وخوادم الخرائط المباشرة تعمل بشكل لا تشوبه شائبة خلال فترات الذروة.',
        'donate.impact3Title': '100$ تجهز فرق البحث',
        'donate.impact3Desc': 'توفر أدوات تنسيق وحزم بيانات تم التحقق منها لمجموعات البحث التطوعية على الأرض.',
        'donate.everySecond': 'كل ثانية لها قيمة',
        'donate.helpUsBring': 'ساعدنا في إعادتهم',
        'donate.themHome': 'إلى ديارهم.',
        'donate.heroDescription': 'العائلات تنتظر. تبرعك يغذي التكنولوجيا والجهود الميدانية للم شمل الأحباء المفقودين.',
        'donate.donateNowCTA': 'تبرع الآن',
        'donate.fillDetails': 'يرجى إدخال اسمك وبريدك الإلكتروني.',
        'donate.thankYou': 'شكراً لك',
        'donate.simulationMsg': 'تبرعك يساعد في إعادتهم إلى ديارهم. (محاكاة)',
    ...
    createPost: {
        ...
        reporterPhone: 'رقم الهاتف',
        reporterPhonePlaceholder: 'رقم الهاتف',
