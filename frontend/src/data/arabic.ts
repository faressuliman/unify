export const ar = {
  translations: {
    ...
    "search.imageSearchDesc":
      "قم برفع صورة للعثور على تطابقات محتملة باستخدام نظام التعرف على الوجوه لدينا.",
    ...
    "search.tipText":
      "جميع الحقول اختيارية. استخدم أي عدد تريده من المعايير. إرفاق صورة مع الفلاتر سيعطي أدق النتائج.",
    "poster.breadcrumb": "الرئيسية > منشئ الملصقات",
    "poster.title": "تنبيه عن شخص مفقود",
    "poster.subtitle":
      "اتبع الخطوات أدناه لإنشاء ملصق احترافي عالي التأثير للشخص المفقود. بياناتك مشفرة وآمنة.",
    ...
    "poster.clothingPlaceholder":
      "وشوم، ندبات، نظارات، الملابس التي كان يرتديها...",
  ...
  signup: {
    ...
    joinRevolutionary:
      "انضم إلى منصة ثورية تجمع بين التعاطف الإنساني والذكاء الاصطناعي المتقدم للعثور على المفقودين.",
    aiFaceMatching: "مطابقة الوجه بالذكاء الاصطناعي",
    aiFaceDesc:
      "تقوم خوارزميات الرؤية الحاسوبية المتقدمة بفحص المصادر العامة للعثور على تطابقات على الفور.",
    realTimeAlerts: "تنبيهات في الوقت الفعلي",
    realTimeDesc:
      "احصل على إشعار فوري عند وجود رؤية محتملة بالقرب من المناطق المستهدفة.",
    needs: "يحتاج:",
    pwdWeak: "ضعيف",
    pwdFair: "متوسط",
    pwdGood: "جيد",
    ...
    validation: {
      ...
      "Phone number must be exactly 11 digits":
        "رقم الهاتف يجب أن يكون 11 رقماً",
  ...
  login: {
    ...
    heroSubtitle:
      "واصل رحلتك في مساعدة العائلات على لم الشمل وإعادة الأمل لمن يبحثون عن أحبائهم.",
    email: "البريد الإلكتروني",
    password: "كلمة المرور",
    rememberMe: "تذكرني",
  ...
  createPost: {
    ...
    heroSubtitle:
      "أبلغ عن شخص مفقود أو معثور عليه للمساعدة في لم شمل العائلات.",
    ...
    removeText: "إزالة",
    photoWarning:
      "تتم مراجعة جميع التقديمات من قبل فريقنا. سيتم حماية صور الأشخاص المفقودين وفقًا لسياسة الخصوصية الخاصة بنا.",
    photoWarningBadge:
      "تتم مراجعة جميع التقديمات من قبل فريقنا. سيتم حماية صور الأشخاص المفقودين وفقًا لسياسة الخصوصية الخاصة بنا.",
    cancel: "إلغاء",
    submit: "نشر",
  ...
  hero: {
    ...
    subtitle:
      "منصة مدعومة بالذكاء الاصطناعي ومعتمدة من وزارة التضامن الاجتماعي لمساعدتكم في العثور على أحبائكم وإعادتهم إلى عائلاتهم.",
  ...
  recentUpdates: {
    ...
    foundModal: {
      ...
      photoVisibleAfterVerification:
        "تظهر الصورة الكاملة بعد التحقق من المطالبة",
      ...
      claimSummary:
        'إذا كانت لديك معلومات عن هذا الشخص، يرجى الضغط على "مطالبة كفرد من العائلة" لبدء عملية التحقق. تتم مراجعة جميع المطالبات بواسطة جهات مختصة.',
      ...
      relationshipPlaceholder:
        "مثال: أنا ابنه/ابنته، أخوه/أخته، والده/والدته، الزوج/الزوجة... يرجى توضيح صلتك وكيف تعرف هذا الشخص.",
      ...
      documentHint:
        "ارفع مستنداً يثبت صلتك: بطاقة رقم قومي، شهادة ميلاد، صورة عائلية، أو أي مستند يحتوي على الاسمين.",
      documentButton: "اختيار ملف",
      documentChange: "تغيير المستند",
      documentRemove: "إزالة",
      documentError: "يرجى رفع صورة مستند تحقق.",
      claimNotice:
        "ستتم مراجعة مطالبتك من قبل جهات مختصة. ستصلك إشعارات عند اكتمال التحقق.",
      cancel: "إلغاء",
    ...
    missingModal: {
      ...
      photoProtected: "الصورة محمية",
      photoVisibleAfterVerification:
        "تظهر الصورة الكاملة للمستخدمين المصرح لهم",
      personalDetails: "البيانات الشخصية",
      locationDetails: "تفاصيل الموقع",
      age: "العمر",
      physicalDescription: "الوصف الجسدي",
      ...
      sightingSummary:
        "إذا كنت قد رأيت هذا الشخص، يرجى تقديم التفاصيل لمساعدة عائلته في العثور عليه. سيتم الحفاظ على سرية هويتك.",
  ...
  footer: {
    brand: "يونيفاي",
    description:
      "نعمل على إعادة ربط الأشخاص المفقودين بعائلاتهم باستخدام الذكاء الاصطناعي، والتحقق من الهوية، وإشراف السلطات. عائلتك هي أولويتنا.",
