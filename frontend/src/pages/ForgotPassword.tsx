          ...
          >
              ...
              <form onSubmit={handleSubmit} className="space-y-6 flex-1">
                ...
                <div>
                  <FormInput
                    ...
                    className={
                      error
                        ? "border-red-400 focus:ring-red-500/50 flex-1 py-4 text-base"
                        : "border-gray-200/80 focus:border-secondary flex-1 py-4 text-base"
                    }
                  />
                  <ErrorMessage
                    msg={error}
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-[15px] opacity-90 leading-relaxed">
                    {isRTL
                      ? "لقد أرسلنا رمز إعادة تعيين كلمة المرور (OTP) إلى "
                      : "We have sent a password reset OTP code to "}
            ...
            <p className="text-center text-[15px] text-gray-500 mt-10 md:mt-8 font-medium">
              ...
              >
                {content.signIn}
                {isRTL ? (
                  <ArrowUpLeft className="w-5 h-5 text-secondary inline-block align-middle ml-1" />
                ) : (
                  <ArrowUpRight className="w-5 h-5 text-secondary inline-block align-middle ml-1" />
                )}
              </Link>
            </p>
          </motion.div>
