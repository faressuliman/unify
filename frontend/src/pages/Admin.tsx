            ...
            {activeSection === "overview" && user?.role === "admin" && (
              <div className="flex justify-end pb-2">
                <button
                  ...
                  disabled={isSeeding}
                  className="inline-flex items-center gap-2 px-4 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl shadow-sm transition-all disabled:opacity-50 cursor-pointer"
                >
                  {isSeeding ? (
                  ...
                  {isRTL ? "توليد بيانات تجريبية" : "Generate Dummy Data"}
                </button>
              </div>
            )}
